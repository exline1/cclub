                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-4 pl-6 flex items-center gap-3">
                      {failedImages[id] ? (
                        <div className={cn(
                          "h-10 w-10 rounded-full bg-background-secondary border border-border-glass/40 flex items-center justify-center shrink-0 text-text-secondary/70",
                        ...
                        <img
                          ...
                          alt={name}
                          className={cn(
                            "h-10 w-10 rounded-full object-cover bg-background-primary border shrink-0 transition-transform group-hover:scale-105 duration-200",
                    ...
                    <td className="p-4">
                      <span
                        className={cn(
                          "px-2 py-0.5 rounded-full-50px text-[10px] font-bold border capitalize",
                    ...
                    <td className="p-4 text-center">
                      <span
                        className={cn(
                          "font-heading font-extrabold text-xs px-2 py-0.5 rounded-full-50px border",
                    ...
                    <td className="p-4 text-center">
                      {isOutOfStock ? (
                        <span className="inline-flex items-center gap-1 text-[10px] font-bold text-status-occupied uppercase tracking-wider bg-status-occupied/5 border border-status-occupied/20 px-2 py-0.5 rounded-full">
                          Tugagan
                        </span>
                      ) : isLowStock ? (
                        <span className="inline-flex items-center gap-1 text-[10px] font-bold text-status-ending uppercase tracking-wider bg-status-ending/5 border border-status-ending/20 px-2 py-0.5 rounded-full">
                          <AlertTriangle className="h-3 w-3 shrink-0" />
                          Kam qoldi
                        </span>
                      ) : (
                        <span className="inline-flex items-center gap-1 text-[10px] font-bold text-status-free uppercase tracking-wider bg-status-free/5 border border-status-free/20 px-2 py-0.5 rounded-full">
                          Mavjud
                        </span>
                      )}
                    </td>
                    ...
                    <td className="p-4 pr-6 text-center">
                      <div className="flex justify-center items-center gap-2">
                        <button
                          ...
                          className="p-1.5 rounded-full border border-border-glass/40 bg-background-primary/30 text-text-secondary hover:text-accent-glow hover:border-accent-glow/50 active:scale-95 transition-all duration-200"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-full border border-border-glass/40 bg-background-primary/30 text-text-secondary hover:text-status-occupied hover:border-status-occupied/50 active:scale-95 transition-all duration-200"
                        >
