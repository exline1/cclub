      ...
      <div className="relative glass-card w-full max-w-lg    p-6 shadow-2xl z-10 overflow-hidden max-h-[85vh] flex flex-col animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 overflow-y-auto pr-1 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-background-primary/40 border border-border-glass/25 rounded-2xl text-left space-y-0.5">
          ...
          {/* Contact and Visits */}
          <div className="p-3.5 bg-background-primary/40 border border-border-glass/20 rounded-2xl text-left space-y-2 text-xs">
          ...
          <div className="space-y-2.5 text-left">
            ...
            <div className="space-y-2">
              {customerHistory.map((log, idx) => (
                <div
                  key={idx}
                  className="p-3 bg-background-primary/20 border border-border-glass/10 rounded-2xl flex items-start justify-between gap-3 text-xs"
                >
        ...
        <div className="flex gap-3 pt-3 border-t border-border-glass/40 mt-4 shrink-0">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 py-2 px-4 rounded-2xl bg-background-primary border border-border-glass hover:border-accent-glow/50 text-text-secondary hover:text-text-primary transition-all duration-200 text-xs font-bold active:scale-95"
          >
            Yopish
          </button>
        </div>
