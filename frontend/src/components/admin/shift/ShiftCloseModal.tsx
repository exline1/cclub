...
export default function ShiftCloseModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative glass-card w-full max-w-lg rounded-2xl border border-border-glass bg-background-secondary p-6 shadow-2xl z-10 overflow-hidden max-h-[90vh] flex flex-col animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 overflow-y-auto pr-1">
          {!isShiftClosed ? (
            ...
            <div className="space-y-4 text-center py-4">
              ...
              {/* Quick Info Box */}
              <div className="p-3.5 bg-background-primary/40 border border-border-glass/20 rounded-xl text-left text-xs max-w-sm mx-auto space-y-1">
              ...
              <div className="flex gap-3 pt-4 max-w-sm mx-auto">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 px-4 rounded-xl bg-status-occupied hover:bg-status-occupied/90 text-white font-bold transition-all duration-200 text-xs active:scale-95 shadow-lg shadow-status-occupied/10"
                >
                  Smenani Yopish
                </button>
              </div>
            ...
            <div className="space-y-5 py-2 text-left">
              ...
              <div className="flex items-center gap-3 p-3.5 rounded-xl border border-status-free/20 bg-status-free/5">
              ...
              <div className="glass-card border border-border-glass/40 bg-background-primary/45 rounded-2xl p-4 space-y-4">
                ...
                <div className="border-t border-border-glass/25 pt-3 grid grid-cols-2 gap-2 text-[10px] text-text-secondary">
                  <div className="p-2 bg-background-secondary/60 rounded-lg text-left">
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-full py-2.5 px-4 rounded-xl bg-accent-glow hover:bg-accent-glow/90 text-white font-bold transition-all duration-200 text-xs active:scale-95 shadow-lg shadow-accent-glow/15"
              >
                Yopish va Yakunlash
              </button>
            </div>
