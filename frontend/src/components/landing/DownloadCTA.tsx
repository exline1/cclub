        ...
        >
          ...
          <div className="flex-1 text-center md:text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button asChild size="lg" className="h-14 px-8 bg-accent-primary hover:bg-accent-glow text-white  shadow-accent-glow-sm transition-transform active:scale-95 group">
          ...
          >
            ...
            <div className="relative w-72 h-[450px] bg-background-primary rounded-50px border border-border-primary shadow-accent-glow flex flex-col overflow-hidden rotate-2 hover:rotate-0 transition-all duration-700">
              ...
              <div className="flex-1 bg-card-gradient flex flex-col items-center justify-center p-6">
                 ...
                 <div className="w-full space-y-4">
                   <div className="h-20 w-full bg-background-tertiary rounded-2xl border border-border-primary"></div>
                   <div className="h-20 w-full bg-background-tertiary rounded-2xl border border-border-primary"></div>
                   <div className="h-20 w-full bg-background-tertiary rounded-2xl border border-border-primary"></div>
                 </div>
              </div>
